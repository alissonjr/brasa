import{aK as e,b6 as t,b7 as r,b8 as n,b9 as l,ba as s,bb as f,b0 as c,bc as d,bd as p,be as S,bf as u,bg as _}from"./babylon-C8afoLCT.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const m=[t,r,n,l,s,f,c,d,p,S,u,_];for(const o of m)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const D={name:a,shader:i};export{D as gaussianSplattingVertexShader};
