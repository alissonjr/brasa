import{aK as e,aS as o,aT as i,aU as n,aV as s,aW as l,aM as f,aX as u,aY as d,aZ as c,a_ as p}from"./babylon-C8afoLCT.js";const a="gaussianSplattingVertexShader",r=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=r);const x=[o,i,n,s,l,f,u,d,c,p];for(const t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const v={name:a,shader:r};export{v as gaussianSplattingVertexShaderWGSL};
