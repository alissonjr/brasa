import{aK as e,aV as i,aW as n,aM as a,aY as s,aZ as f,a_ as l}from"./babylon-C8afoLCT.js";const r="gpuRenderParticlesVertexShader",o=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=o);const v=[i,n,a,s,f,l];for(const t of v)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const c={name:r,shader:o};export{c as gpuRenderParticlesVertexShaderWGSL};
